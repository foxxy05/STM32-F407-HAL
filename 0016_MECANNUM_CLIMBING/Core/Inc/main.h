...
#define RR_LPWM_Pin GPIO_PIN_14
#define RR_LPWM_GPIO_Port GPIOD
#define RR_RPWM_Pin GPIO_PIN_15
#define RR_RPWM_GPIO_Port GPIOD
#define RF_RPWM_Pin GPIO_PIN_6
#define RF_RPWM_GPIO_Port GPIOC
#define RF_LPWM_Pin GPIO_PIN_7
#define RF_LPWM_GPIO_Port GPIOC
